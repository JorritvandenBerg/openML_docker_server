...
6. Set the EMAIL_FROM_ADDRESS and EMAIL_API_LOG_ADDRESS to send registration mails en receive API logs by mail.
7. Optionally set the protocol with OPENML_PROTOCOL to https (defaults to http)
8. Visit Localhost:3000 or the (sub)domain on which you deployed OpenML
